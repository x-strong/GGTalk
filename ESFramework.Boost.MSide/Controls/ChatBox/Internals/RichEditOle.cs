...
namespace ESFramework.Boost.Controls.Internals
{
    internal class RichEditOle
    {
        ...
        //public void Clear()
        //{
        //    List<REOBJECT> list = this.GetAllREOBJECT();
        //    foreach (REOBJECT obj in list)
        //    {
        //        REOBJECT reo = new REOBJECT();
        //        reo.polesite = obj.polesite;//必须指定这个否则执行插入报错
        //        IRichEditOle.InsertObject(reo);
        //    }
        //}
