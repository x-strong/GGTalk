    ...
    public partial class FileTransferItem : UserControl
    {
        ...
        public bool IsTransfering
        {
            ...
            { 
                ...
                if (isTransfering)
                {
                    this.label_offlineSend.Visible = false;
                }
            }
        }
        ...
        public void Initialize(TransferingProject info, bool offlineFile, bool doneAgreed)
        {
            ...
            if (info.IsSender)
            {
                ...
                this.label_offlineSend.Visible = !offlineFile &&　!NetServer.IsServerUser(this.transmittingFileInfo.DestUserID) && info.OriginStream == null;
            }
            else
            {
        ...
        private void label_offlineSend_Click(object sender, EventArgs e)
        {
