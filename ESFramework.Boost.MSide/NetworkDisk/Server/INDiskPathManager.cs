...
namespace ESFramework.Boost.NetworkDisk.Server
{
    ...
    public class NetworkDiskPathManager : INDiskPathManager
    {
        ...
        private string rootPath4PersonalDisk = AppDomain.CurrentDomain.BaseDirectory + "\\PersonalDisk\\";
        /// <summary>
        ...
        private string rootPath4GroupDisk = AppDomain.CurrentDomain.BaseDirectory + "\\GroupDisk\\";
        /// <summary>
