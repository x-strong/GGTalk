...
{   
    ...
    public partial class NDiskBrowser : UserControl, IComparer, INDiskBrowser
    {
        ...
        /// <summary>
        /// 当某个文件上传完毕时，触发此事件。参数：fileName
        /// </summary>
        public event CbGeneric<string> UploadCompleted; 
        ...
        public NDiskBrowser()
        {
            ...
            this.spaceWidth = this.Width - this.toolStripTextBox_path.Width;
            ...
            this.fileTransferingViewer1.FileTransDisruptted += new ESBasic.CbGeneric<string, bool, FileTransDisrupttedType ,string>(fileTransferingViewer1_FileTransDisruptted);            
        }
        ...
        void fileTransferingViewer1_FileTransDisruptted(string fileName, bool isSending, FileTransDisrupttedType disrupttedType ,string cause)
        {
            if (this.IsDisposed)
            {
                return;
        ...
        public void Initialize(string _ownerID, IFileOutter _fileOutter, INDiskOutter outter, string curUserID)
        {
            ...
            this.toolStripLabel_path.Visible = !this.lockRootDirectory;
            this.toolStripTextBox_path.Visible = !this.lockRootDirectory;
            this.toolStripButton_parent.Visible = !this.lockRootDirectory;
            this.toolStripButton_root.Visible = !this.lockRootDirectory;
            this.toolStripButton_newFileFolder.Visible = !this.lockRootDirectory;
        ...
        public void Reset()
        {
            ...
            this.toolStripTextBox_path.Text = "";
        }
        #endregion
        ...
        private void LoadDirectory(string path, bool tipOnException)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    this.toolStripTextBox_path.Text = displayPath;
        ...
        private void DirectoryBrowser_SizeChanged(object sender, EventArgs e)
        {
            ...
            this.toolStripTextBox_path.Width = newWidth;
        }
        #endregion
        ...
        {
            if ((this.ownerSharedAllDisk || this.IsNetworkDisk) && this.ownerID == NetServer.SystemUserID && this.currentDirPath == null)
            {
