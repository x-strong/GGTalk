...
namespace ESFramework.Boost.NetworkDisk.Passive
{
    ...
    public class NDiskPassiveHandler : IIntegratedCustomizeHandler, IDisposable
    {
        ...
        /// 初始化。
        /// </summary>        
        /// <param name="rootPath">当作为磁盘供远程访问时，共享的根目录。如果为null，表示共享整个磁盘。</param>
        ...
        void fileOutter_FileRequestReceived(string projectID, string senderID, ClientType senderType, string fileName, ulong totalSize, ResumedProjectItem resumedFileItem, string comment)
        {
