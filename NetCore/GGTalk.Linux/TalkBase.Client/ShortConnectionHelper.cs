...
namespace TalkBase.Client
{
    ...
    /// 智能多媒体管理器的工作模式。
    /// </summary>
    internal enum MultimediaManagerMode
    {
        Common = 0,
        ConnectOnlyWhenNeed
    }
    ...
    /// <summary>
    /// OMCS短连接帮助类，支持按需连接（在需要的时候，才连接多媒体服务器）。
    /// </summary>
    //public class ShortConnectionHelper 
    //{
    ...
    //    private ShortConnectionHelper() { }

    //    #region Singleton
    //    private static ShortConnectionHelper singleton = new ShortConnectionHelper();
    //    public static ShortConnectionHelper Singleton
    //    {
    //        get
    //        {
    //            return ShortConnectionHelper.singleton;
    //        }
    //    }
    //    #endregion

    //    /// <summary>
    //    /// ShortConnectionHelper内部使用的多媒体管理器实例。管理器实例可能还未完成初始化。
    //    /// </summary>
    ...
    //        {
    //            errorMsg = ee.Message;
    //            this.logger.Log(ee, "OMCS.Passive.ShortConnectionHelper.Prepare", ESBasic.Loggers.ErrorLevel.Standard);
    //            if (rethrow)
    //            {
    //                throw;
    //            }
    ...
    internal sealed class OmcsLoginParas
    {
