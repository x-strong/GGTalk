...
namespace TalkBase.Client
{
    ...
    /// 客户端全局资源中心。
    /// </summary>    
    internal class ResourceCenter<TUser, TGroup> : IResourceCenter  
        ...
        where TGroup : TalkBase.IGroup, new()
    {
        ...
        public void Initialize(IRapidPassiveEngine engine, ITalkBaseHelper<TGroup> helper, TalkBaseInfoTypes types, string globalCacheFilePath, string sqliteFilePath, IAgileLogger agileLogger, IChatRecordGetter remote, IMessageCacheManager _messageCacheManager)
        {
            ...
            this.clientHandler.Initialize(this, _messageCacheManager);

            //this.chatFormController.FormCreated += new ESBasic.CbGeneric<System.Windows.Forms.Form, IUnit>(chatFormController_FormCreated);
        }

        //void chatFormController_FormCreated(System.Windows.Forms.Form form, IUnit unit)
        //{
