...
namespace TalkBase.Client
{
        ...
        where TGroup : TalkBase.IGroup, new()
    {
        ...
        /// <summary>
        /// 最后聊天记录更改 IUnit：聊天对象   bool：是发送还是收到的消息  true：收到的新消息， false：自己发送的消息
        /// </summary>
        ...
        //    GGTalk.Linux.Controls.ChatBoxContent2 chatBoxContent = new GGTalk.Linux.Controls.ChatBoxContent2("[语音消息]", SystemSettings.DefaultSimpleFont, System.Drawing.Color.Black);
        ...
        public void OnHandleAddFriendRequestReceived(string friendID,bool isRequester, bool isAgreed)
        {
            ...
            {
                this.AddFriendResponseReceived(friendID, isRequester, isAgreed);
            }
        }
        ...
        /// 发送聊天消息。
        /// </summary>      
        public ChatMessageRecord SendChatMessage(string destUserID, byte[] msg)
        {
            byte[] encrypted = msg;
            if (this.desEncryption != null)
            {
            ...
            //使用Tag携带 接收者的ID
            this.rapidPassiveEngine.SendMessage(null, this.talkBaseInfoTypes.Chat, encrypted, destUserID, true);
        ...
        public void SendChatMessage(List<string> accepters, byte[] msg)
        {
            ...
            this.rapidPassiveEngine.SendMessage(null, this.talkBaseInfoTypes.ChatTransfered, encrypted, ids, true);
        ...
        /// 发送语音消息。
        /// </summary>      
        //public void SendAudioMessage(string destUserID, AudioMessage msg)
        //{
        ...
        /// 发送群聊天消息。
        /// </summary>      
        public ChatMessageRecord SendGroupChatMessage(string groupID, byte[] msg, string tag)
        {
            byte[] encrypted = msg;
            if (this.desEncryption != null)
            {
            ...
            this.rapidPassiveEngine.ContactsOutter.BroadcastBlob(groupID, this.talkBaseInfoTypes.GroupChat, encrypted, tag, 2048);
        ...
        public void SendMediaCommunicate(string destUserID, CommunicateMediaType mediaType, CommunicateType communicateType, string tag, ClientType? destClientType = null)
        {
            ...
            if (communicateType == CommunicateType.Agree || communicateType == CommunicateType.Reject)
            {
        ...
        ///// <summary>
        ///// 收到自己（其他端）退出群事件 参数 groupID
        ///// </summary>
        //public event CbGeneric<string> OnQuitGroupEchoReceivedEvent;
        ///// <summary>
        ///// 收到自己（其他端）退出群消息
        ///// </summary>
        ///// <param name="groupID"></param>
        //public void OnQuitGroupEchoReceived(string groupID)
        //{
        //    this.clientGlobalCache.RemoveGroup(groupID);
        //    this.clientGlobalCache.CurrentUser.QuitGroup(groupID);
        //    if (this.OnQuitGroupEchoReceivedEvent != null) {
        //        this.OnQuitGroupEchoReceivedEvent(groupID);
        //    }
        //}

        ///// <summary>
        ///// 收到自己（其他端）删除群事件 参数 groupID
        ///// </summary>
        //public event CbGeneric<string> OnDeleteGroupEchoReceivedEvent;
        ///// <summary>
        ///// 收到自己（其他端）删除群消息
        ///// </summary>
        ///// <param name="groupID"></param>
        //public void OnDeleteGroupEchoReceived(string groupID)
        //{
        //    this.clientGlobalCache.RemoveGroup(groupID);
        //    this.clientGlobalCache.CurrentUser.QuitGroup(groupID);
        //    if (this.OnDeleteGroupEchoReceivedEvent != null)
        //    {
        //        this.OnDeleteGroupEchoReceivedEvent(groupID);
        //    }
        //}
        ...
        public void ChangeMyHeadImage(int defaultHeadImageIndex, byte[] customizedHeadImage)
        {
            ...
            byte[] data = ESPlus.Serialization.CompactPropertySerializer.Default.Serialize(contract);
            this.rapidPassiveEngine.SendMessage(null, this.talkBaseInfoTypes.ChangeMyHeadImage, data, null,true);
