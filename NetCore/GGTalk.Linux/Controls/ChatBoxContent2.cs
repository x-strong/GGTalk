...
{
    internal enum ChatBoxContextMenuMode
    {
        None = 0,
        ForInput,
        ForOutput
    ...
    #region ChatBoxContent2
    /// <summary>
    /// 封装完整的一个聊天消息，消息中可以包含表情和图片。    
    /// 注意：Text属性的值表示纯文本信息，而图片都变成了文本中的对应位置的占位符（空格）。
    /// </summary>
    [Serializable]
    public class ChatBoxContent2
    {
        public ChatBoxContent2() { }
        public ChatBoxContent2(string _text, SimpleFont _font, Color c)
        {
            this.text = _text;
            this.font = _font;
            this.color = c;
        ...
        public void AddForeignImage(uint pos, CPF.Drawing.Image img)
        {
    ...
    public class NonTextItem
    {
        ...
        public NonTextItem(CPF.Drawing.Image img)
        {
        ...
        #region ForeignImage
        private CPF.Drawing.Image foreignImage = null;
        /// <summary>
        /// 当ChatBoxElementType为ForeignImage时使用。
        /// </summary>
        public CPF.Drawing.Image ForeignImage
        {
