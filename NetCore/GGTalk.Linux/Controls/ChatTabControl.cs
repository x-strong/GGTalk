...
{
    internal class ChatTabControl : TabControl
    {
        public event Action<TabItem> SelectionChanged;
        ...
        protected override void OnSwitch(TabItem oldItem, TabItem newItem)
        {
            base.OnSwitch(oldItem, newItem);
            if (this.SelectionChanged != null)
            {
                this.SelectionChanged(newItem);
            }
        }
    }
}
