...
{
    internal class TreeViewItemTemplate : TreeViewItem
    {
        ...
        {//模板定义
            ...
            String sta = CommonOptions.ResourcesCatalog+ "a.png";
            String stb = CommonOptions.ResourcesCatalog + "b.png";
                   ...
                   new StackPanel
                   {
                       ...
                       Children={
                             new Picture
                            {
                                ...
                                Source = sta,
                                Bindings={
                                    { nameof(Picture.Source),nameof(IsExpanded),3,BindingMode.OneWay,a=>(bool)a? sta:stb},
        ...
        protected override void OnLayoutUpdated()
        {
            ...
            if (Items.Count > 0)
            {
                EndPoint = new Point(1, (ItemsHost.Children[Items.Count - 1]).ActualOffset.Y + 24);
            }
            else {
        ...
        {
            if (HasItems && IsExpanded && this != ParentItem.Items[ParentItem.Items.Count - 1])
            {
