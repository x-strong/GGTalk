...
namespace GGTalk
{
    ...
    public class GGUser : UserBase, IEntity<System.String>
    {
        ...
        [NonSerialized]
        private ChatBoxContent2 lastChatBoxContent = null;
        public ChatBoxContent2 LastChatBoxContent
        {
            get
            {
                if (this.lastChatBoxContent == null)
                {
                    ...
                    {
                        this.lastChatBoxContent = ESPlus.Serialization.CompactPropertySerializer.Default.Deserialize<ChatBoxContent2>(base.LastWordsRecord.ChatContent, 0);
                    }
                }
