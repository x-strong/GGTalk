...
{
    [Serializable]
    public class GroupBase : IGroup, INotifyPropertyChanged
    {
        ...
        public string Announce
        {
            ...
            set { announce = value;
                if (this.PropertyChanged != null)
                {
                    this.PropertyChanged.Invoke(this, new PropertyChangedEventArgs(nameof(Announce)));
                }
            }
        } 
        #endregion
        ...
        public string Members
        {
            ...
            { 
                ...
                if (this.PropertyChanged != null)
                {
                    this.PropertyChanged.Invoke(this, new PropertyChangedEventArgs(nameof(Members)));
                    this.PropertyChanged.Invoke(this, new PropertyChangedEventArgs(nameof(MemberCount)));
                }
            }
        }
