...
namespace OMCS.Boost.Forms
{
    ...
    public partial class DeviceSelectForm : Form
    {
        ...
        private DynamicCameraConnector dynamicCameraConnector1 = new DynamicCameraConnector();
        private string userID;
        private AgileIPE ipe;
        ...
        public DeviceSelectForm(IMultimediaManager mgr)
        {
            ...
            this.dynamicCameraConnector1.ConnectEnded += new CbGeneric<string,ConnectResult>(cameraConnector1_ConnectEnded);
            this.microphoneConnector1.ConnectEnded += new CbGeneric<string, ConnectResult>(microphoneConnector1_ConnectEnded);
        ...
        void microphoneConnector1_ConnectEnded(string ownerID, ConnectResult res)
        {
            if (this.InvokeRequired)
            {
        ...
        void cameraConnector1_ConnectEnded(string ownerID, ConnectResult res)
        {
            if (this.InvokeRequired)
            {
                this.BeginInvoke(new CbGeneric<string, ConnectResult>(this.cameraConnector1_ConnectEnded), ownerID, res);
            }                
            else
            {
                if (res != ConnectResult.Succeed)
        ...
        private void button_start_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //尝试连接设备
                this.dynamicCameraConnector1.BeginConnect(this.userID);
