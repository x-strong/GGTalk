...
namespace GGTalk.Controls.ChatRender4Dll
{
    internal class RenderBox
    {
        ...
        {
            this.chatRender = ChatRenderFactory.CreateChatRender(RenderAttr.DataProvider, attr.chatBox,
                attr.mySelfTag, attr.otherTag, attr.multiSpeaker, attr.renderType);
            //this.chatRender = ChatRenderFactory.CreateChatRender(RenderAttr.DataProvider, attr.chatBox,
            //    attr.mySelfTag, attr.otherTag,false);
        ...
        internal event Action<string,Image> ImageMessageClicked;
        ...
        private void ChatRender_ImageClicked(string guid, object noSourceImg)
        {
            if (this.ImageMessageClicked != null)
                this.ImageMessageClicked(guid,(Image)noSourceImg);
        }
