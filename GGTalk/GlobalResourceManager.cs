    ...
    internal class GlobalResourceManager
    {
        public static void Initialize()
        {
            ...
            {             
                ...
                GlobalResourceManager.noneIcon64 = global::GGTalk.Properties.Resources.Oraycn64;               
                GlobalResourceManager.groupIcon = ImageHelper.ConvertToIcon(global::GGTalk.Properties.Resources.normal_group_40,64);
                GlobalResourceManager.notifyIcon = ImageHelper.ConvertToIcon(global::GGTalk.Properties.Resources.notify, 64);
                ...
                GlobalResourceManager.remotingService = (IGGService)Activator.GetObject(typeof(IGGService), string.Format("tcp://{0}:{1}/GGService", ConfigurationManager.AppSettings["ServerIP"], registerPort));
        ...
        public static Image FileAssistantImage
        {
            get
            {
        ...
        #region NotifyIcon
        private static Icon notifyIcon;
