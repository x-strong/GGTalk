...
namespace GGTalk
{
    ...
    {
        public static string SystemSettingsDir = Environment.GetFolderPath(Environment.SpecialFolder.Personal) + "\\GGTalk8.0\\" ;
        ...
        #region ChatFormSize
        private Size chatFormSize = new Size(740, 600);
        /// <summary>
        /// 聊天窗口的大小
        /// </summary>
        public Size ChatFormSize
        {
            get
            {
                ...
                {
                    this.chatFormSize = new Size(740, 600);
                }
                return chatFormSize;
            }
